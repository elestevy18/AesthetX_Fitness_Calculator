...
public class AddRadialForearmVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddRadialForearmVolumeDialog(Context mContext) {
    ...
    private final TextView.OnEditorActionListener editorListener = new TextView.OnEditorActionListener() {
        ...
        public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_NEXT) {
                ...
                int radialForearmTally = Integer.parseInt(sets);
                radialForearmTally = radialForearmTally * 10;
                SharedPreferences.Editor editor = sp.edit();
                editor.putInt(RADIALFOREARM_TALLY, radialForearmTally);
                editor.apply();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_radialforearm_volume_dialog, null);
