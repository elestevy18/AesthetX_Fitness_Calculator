...
public class AddErectorsVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddErectorsVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_erectors_volume_dialog, null);
