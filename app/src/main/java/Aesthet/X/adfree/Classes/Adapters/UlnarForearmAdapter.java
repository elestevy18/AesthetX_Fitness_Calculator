...
import Aesthet.X.adfree.Classes.MuscleGroupObjects.UlnarForearmList;

public class UlnarForearmAdapter extends RecyclerView.Adapter<UlnarForearmAdapter.ExampleViewHolder> {
    private final ArrayList<UlnarForearmList> mUlnarForearms;
    ...
    public UlnarForearmAdapter(ArrayList<UlnarForearmList> mUlnarForearms, OnItemClickListener mListener) {
        this.mUlnarForearms = mUlnarForearms;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        UlnarForearmList currentItem = mUlnarForearms.get(position);
