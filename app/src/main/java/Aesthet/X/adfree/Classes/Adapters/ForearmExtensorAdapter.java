...
import Aesthet.X.adfree.Classes.MuscleGroupObjects.ForearmExtensorList;

public class ForearmExtensorAdapter extends RecyclerView.Adapter<ForearmExtensorAdapter.ExampleViewHolder> {
    private final ArrayList<ForearmExtensorList> mForearmExtensors;
    ...
    public ForearmExtensorAdapter(ArrayList<ForearmExtensorList> mForearmExtensors, OnItemClickListener mListener) {
        this.mForearmExtensors = mForearmExtensors;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ForearmExtensorList currentItem = mForearmExtensors.get(position);
