...
public class GluteMediusAdapter extends RecyclerView.Adapter<GluteMediusAdapter.ExampleViewHolder> {
    private final ArrayList<GluteMediusList> mGluteMediuss;
    ...
    public GluteMediusAdapter(ArrayList<GluteMediusList> mGluteMediuss, OnItemClickListener mListener) {
        this.mGluteMediuss = mGluteMediuss;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        GluteMediusList currentItem = mGluteMediuss.get(position);
