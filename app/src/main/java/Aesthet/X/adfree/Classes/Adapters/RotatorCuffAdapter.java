...
import Aesthet.X.adfree.Classes.MuscleGroupObjects.RotatorCuffList;

public class RotatorCuffAdapter extends RecyclerView.Adapter<RotatorCuffAdapter.ExampleViewHolder> {
    private final ArrayList<RotatorCuffList> mRotatorCuffs;
    ...
    public RotatorCuffAdapter(ArrayList<RotatorCuffList> mRotatorCuffs, OnItemClickListener mListener) {
        this.mRotatorCuffs = mRotatorCuffs;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        RotatorCuffList currentItem = mRotatorCuffs.get(position);
