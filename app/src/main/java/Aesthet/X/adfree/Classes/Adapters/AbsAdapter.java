...
import Aesthet.X.adfree.Classes.MuscleGroupObjects.AbsList;

public class AbsAdapter extends RecyclerView.Adapter<AbsAdapter.ExampleViewHolder> {
    private final ArrayList<AbsList> mAbss;
    ...
    public AbsAdapter(ArrayList<AbsList> mAbss, OnItemClickListener mListener) {
        this.mAbss = mAbss;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        AbsList currentItem = mAbss.get(position);
