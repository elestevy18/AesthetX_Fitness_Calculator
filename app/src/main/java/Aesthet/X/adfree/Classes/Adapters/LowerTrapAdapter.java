...
public class LowerTrapAdapter extends RecyclerView.Adapter<LowerTrapAdapter.ExampleViewHolder> {
    private final ArrayList<LowerTrapExerciseList> mLowerTrapExercises;
    private final OnItemClickListener mListener;

    public LowerTrapAdapter(ArrayList<LowerTrapExerciseList> mLowerTrapExercises, OnItemClickListener mListener) {
        this.mLowerTrapExercises = mLowerTrapExercises;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        LowerTrapExerciseList currentItem = mLowerTrapExercises.get(position);
    ...
    public int getItemCount() {
        return mLowerTrapExercises.size();
    }
