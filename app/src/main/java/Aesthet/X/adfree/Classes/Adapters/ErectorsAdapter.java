...
public class ErectorsAdapter extends RecyclerView.Adapter<ErectorsAdapter.ExampleViewHolder> {
    private final ArrayList<ErectorsList> mErectorss;
    ...
    public ErectorsAdapter(ArrayList<ErectorsList> mErectorss, OnItemClickListener mListener) {
        this.mErectorss = mErectorss;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ErectorsList currentItem = mErectorss.get(position);
