...
public class DiaphragmAdapter extends RecyclerView.Adapter<DiaphragmAdapter.ExampleViewHolder> {
    private final ArrayList<DiaphragmList> mTransverses;
    ...
    public DiaphragmAdapter(ArrayList<DiaphragmList> mTransverses, OnItemClickListener mListener) {
        this.mTransverses = mTransverses;
        this.mListener = mListener;
    }

    @Override
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        DiaphragmList currentItem = mTransverses.get(position);
