...
public class SerratusAdapter extends RecyclerView.Adapter<SerratusAdapter.ExampleViewHolder> {
    private final ArrayList<SerratusList> mSerratuss;
    ...
    public SerratusAdapter(ArrayList<SerratusList> mSerratuss, OnItemClickListener mListener) {
        this.mSerratuss = mSerratuss;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        SerratusList currentItem = mSerratuss.get(position);
