...
public class AddPosteriorDeltoidVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddPosteriorDeltoidVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_posteriordeltoid_volume_dialog, null);
