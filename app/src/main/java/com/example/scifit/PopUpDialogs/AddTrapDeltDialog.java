...
public class AddTrapDeltDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddTrapDeltDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_medialdeltoid_volume_dialog, null);
        ...
        builder.setView(view)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        upperTrapTally = upperTrapTally /2;
