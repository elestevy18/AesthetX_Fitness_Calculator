...
public class AddAbsVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddAbsVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_abs_volume_dialog, null);
