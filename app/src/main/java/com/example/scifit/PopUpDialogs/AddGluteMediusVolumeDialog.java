...
public class AddGluteMediusVolumeDialog extends AppCompatDialogFragment {
    ...
    private com.example.scifit.PopUpDialogs.AddGluteMediusVolumeDialog.ExampleDialogListener listener;
    private Context mContext;
    private EditText mvolume;

    //private EditText mvolume;
    public AddGluteMediusVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_glutemedius_volume_dialog, null);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (com.example.scifit.PopUpDialogs.AddGluteMediusVolumeDialog.ExampleDialogListener) context;
