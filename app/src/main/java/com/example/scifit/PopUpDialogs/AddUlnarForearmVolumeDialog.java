...
public class AddUlnarForearmVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddUlnarForearmVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_ulnarforearm_volume_dialog, null);
        ...
        builder.setView(view)
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        //  intent.putExtra(ULNARFOREARM_TALLY, ulnarForearmTally);
