...
//get data
        ...
        final float idealBodyWeight = (float) (developedLeanMass * 1.2);
        final float fatLoss = (float) ((bodyweight * (composition * .01)) - (bodyweight * .20));
        ...
        if(experience == 0){
            ...
            currentMuscleGrowthD = (float) ((69.98 + (-0.00531397 - 67.38605) / Math.pow(mgConstant, 0.8790314)))-5.05;
            currentMuscleGrowth = (float) currentMuscleGrowthD;
