...
public class Activity7 extends AppCompatActivity {
    ...
    public static final String EXTRA_MALE = "com.example.application.scifit.MALE";
    public static final String EXTRA_FEMALE = "com.example.application.scifit.FEMALE";
    public static final String EXTRA_EXPERIENCE_3 = "com.example.application.scifit.EXPERIENCE_3";
    public static final String EXTRA_BODYWEIGHT_5 = "com.example.application.scifit.EXTRA_BODYWEIGHT_5";
    public static final String EXTRA_HEIGHT_FEET_4= "com.example.application.scifit.EXTRA_ FEET_4";
    public static final String EXTRA_HEIGHT_INCHES_4 = "com.example.application.scifit.EXTRA_ INCHES_4";
    public static final String EXTRA_COMPOSITION_2 = "com.example.application.scifit.COMPOSITION_2";
