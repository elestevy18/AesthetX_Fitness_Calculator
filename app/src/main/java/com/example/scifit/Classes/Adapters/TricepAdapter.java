...
public class TricepAdapter extends RecyclerView.Adapter<TricepAdapter.ExampleViewHolder> {
    private ArrayList<TricepList> mTriceps;
    ...
    public TricepAdapter(ArrayList<TricepList> mTriceps, OnItemClickListener mListener){
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        TricepList currentItem = mTriceps.get(position);
