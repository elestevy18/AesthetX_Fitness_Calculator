...
import com.example.scifit.Classes.Adapters.UlnarForearmAdapter;
...
public class UlnarForearmVolume extends AppCompatActivity implements UlnarForearmAdapter.OnItemClickListener, AddUlnarForearmVolumeDialog.ExampleDialogListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UlnarForearmExerciseListList.add(new UlnarForearmList ("Rope Ulnar Deviation", "10-12 Strong contraction"));
        //Front Lever Presses
