...
package com.example.scifit.AddVolume;
        ...
        import com.example.scifit.Classes.Adapters.ForearmFlexorAdapter;
...
public class ForearmFlexorsVolume extends AppCompatActivity implements ForearmFlexorAdapter.OnItemClickListener, AddForearmFlexorVolumeDialog.ExampleDialogListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ForearmFlexorExerciseListList.add(new ForearmFlexorList ("Prone Wrist Curls", "10-15 Strong contraction"));
        ForearmFlexorExerciseListList.add(new ForearmFlexorList ("Wrist Flexed Curls", "8-12 Controlled reps, engage forearms and biceps evenly"));
        //curls
