...
public class ErectorGluteMedius extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public ErectorGluteMedius(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.add_erectors_volume_dialog, null);
