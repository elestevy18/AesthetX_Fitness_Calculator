...
public class AddCalvesVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddCalvesVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_calves_volume_dialog, null);
