...
public class AddForearmFlexorVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddForearmFlexorVolumeDialog(Context mContext) {
    ...
    private final TextView.OnEditorActionListener editorListener = new TextView.OnEditorActionListener() {
        ...
        public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_NEXT) {
                ...
                //intent.putExtra(forearmFlexor_TALLY, forearmFlexorTally);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_forearmflexor_volume_dialog, null);
