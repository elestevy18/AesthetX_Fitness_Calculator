...
public class AddAbsSerratusVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddAbsSerratusVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.add_serratus_volume_dialog, null);
