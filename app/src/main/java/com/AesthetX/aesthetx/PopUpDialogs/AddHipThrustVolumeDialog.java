...
public class AddHipThrustVolumeDialog extends AppCompatDialogFragment {
    ...
    //private EditText mvolume;
    public AddHipThrustVolumeDialog(Context mContext) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.add_glutes_volume_dialog, null);
