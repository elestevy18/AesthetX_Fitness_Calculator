...
public class UpdateMagicFormula extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_magic_formula);
        ...
        float totalMuscleGrowth = (float) 40;
        float developedLeanMass = (float) (baseLeanMass + totalMuscleGrowth);
        float idealBodyWeight = (float) (developedLeanMass * 1.12);
        float fatLoss = (float) ((bodyweight * (composition * .01)) - (bodyweight * .12));
