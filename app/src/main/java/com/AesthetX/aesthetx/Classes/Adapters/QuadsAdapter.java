...
import com.AesthetX.aesthetx.Classes.MuscleGroupObjects.QuadsList;

public class QuadsAdapter extends RecyclerView.Adapter<QuadsAdapter.ExampleViewHolder> {
    private final ArrayList<QuadsList> mQuadss;
    ...
    public QuadsAdapter(ArrayList<QuadsList> mQuadss, OnItemClickListener mListener) {
        this.mQuadss = mQuadss;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        QuadsList currentItem = mQuadss.get(position);
