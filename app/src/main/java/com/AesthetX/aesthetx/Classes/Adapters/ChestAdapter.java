...
import com.AesthetX.aesthetx.Classes.MuscleGroupObjects.ChestList;

public class ChestAdapter extends RecyclerView.Adapter<ChestAdapter.ExampleViewHolder> {
    private final ArrayList<ChestList> mChests;
    ...
    public ChestAdapter(ArrayList<ChestList> mChests, OnItemClickListener mListener) {
        this.mChests = mChests;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ChestList currentItem = mChests.get(position);
