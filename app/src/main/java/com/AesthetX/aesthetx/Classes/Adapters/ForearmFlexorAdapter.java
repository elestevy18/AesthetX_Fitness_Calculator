...
import com.AesthetX.aesthetx.Classes.MuscleGroupObjects.ForearmFlexorList;

public class ForearmFlexorAdapter extends RecyclerView.Adapter<ForearmFlexorAdapter.ExampleViewHolder> {
    private final ArrayList<ForearmFlexorList> mForearmFlexors;
    ...
    public ForearmFlexorAdapter(ArrayList<ForearmFlexorList> mForearmFlexors, OnItemClickListener mListener) {
        this.mForearmFlexors = mForearmFlexors;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ForearmFlexorList currentItem = mForearmFlexors.get(position);
