...
public class PosteriorDeltoidAdapter extends RecyclerView.Adapter<PosteriorDeltoidAdapter.ExampleViewHolder> {
    private final ArrayList<PosteriorDeltoidList> mPosteriorDeltoids;
    ...
    public PosteriorDeltoidAdapter(ArrayList<PosteriorDeltoidList> mPosteriorDeltoids, OnItemClickListener mListener) {
        this.mPosteriorDeltoids = mPosteriorDeltoids;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        PosteriorDeltoidList currentItem = mPosteriorDeltoids.get(position);
    ...
    public int getItemCount() {
        return mPosteriorDeltoids.size();
    }
