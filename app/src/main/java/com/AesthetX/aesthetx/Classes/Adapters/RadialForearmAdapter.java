...
import com.AesthetX.aesthetx.Classes.MuscleGroupObjects.RadialForearmList;

public class RadialForearmAdapter extends RecyclerView.Adapter<RadialForearmAdapter.ExampleViewHolder> {
    private final ArrayList<RadialForearmList> mRadialForearms;
    ...
    public RadialForearmAdapter(ArrayList<RadialForearmList> mRadialForearms, OnItemClickListener mListener) {
        this.mRadialForearms = mRadialForearms;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        RadialForearmList currentItem = mRadialForearms.get(position);
