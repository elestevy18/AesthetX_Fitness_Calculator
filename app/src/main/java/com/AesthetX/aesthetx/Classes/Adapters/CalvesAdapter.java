...
import com.AesthetX.aesthetx.Classes.MuscleGroupObjects.CalvesList;

public class CalvesAdapter extends RecyclerView.Adapter<CalvesAdapter.ExampleViewHolder> {
    private final ArrayList<CalvesList> mCalvess;
    ...
    public CalvesAdapter(ArrayList<CalvesList> mCalvess, OnItemClickListener mListener) {
        this.mCalvess = mCalvess;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        CalvesList currentItem = mCalvess.get(position);
