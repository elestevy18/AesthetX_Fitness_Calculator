...
import com.AesthetX.aesthetx.Classes.MuscleGroupObjects.BicepsList;

public class BicepsAdapter extends RecyclerView.Adapter<BicepsAdapter.ExampleViewHolder> {
    private final ArrayList<BicepsList> mBiceps;
    ...
    public BicepsAdapter(ArrayList<BicepsList> mBiceps, OnItemClickListener mListener) {
        this.mBiceps = mBiceps;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        BicepsList currentItem = mBiceps.get(position);
