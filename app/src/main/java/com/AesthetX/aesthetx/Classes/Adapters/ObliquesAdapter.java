...
import com.AesthetX.aesthetx.Classes.MuscleGroupObjects.ObliquesList;

public class ObliquesAdapter extends RecyclerView.Adapter<ObliquesAdapter.ExampleViewHolder> {
    private final ArrayList<ObliquesList> mObliquess;
    ...
    public ObliquesAdapter(ArrayList<ObliquesList> mObliquess, OnItemClickListener mListener) {
        this.mObliquess = mObliquess;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ObliquesList currentItem = mObliquess.get(position);
